import numpy as np
from elliptic import get_pg, scalar_mult, point_add
from to_r1cs import code_to_r1cs_with_inputs
from qap import r1cs_to_qap, create_solution_polynomials
...
def verifier():
    ...
    r, A, B, C = code_to_r1cs_with_inputs(fu, [voters_list[3]])
